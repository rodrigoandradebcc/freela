 ...
 * inicial. Autoplay só é permitido mudo pelos navegadores (ver YoutubeEmbed),
 * e `loading="lazy"` faz o player só iniciar quando entra na viewport. O
 * `FeaturedVideo` (card com imagem + overlay) segue disponível em
